...
static void cgxe_mdl_start(InstanceStruct_GBiICrRCBVBLRAQibqTYqF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_GBiICrRCBVBLRAQibqTYqF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_GBiICrRCBVBLRAQibqTYqF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_GBiICrRCBVBLRAQibqTYqF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_GBiICrRCBVBLRAQibqTYqF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_GBiICrRCBVBLRAQibqTYqF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_GBiICrRCBVBLRAQibqTYqF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_GBiICrRCBVBLRAQibqTYqF
...
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_arduinobase_internal_DueDACWrite *obj);
static void mw__internal__call__reset(InstanceStruct_GBiICrRCBVBLRAQibqTYqF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_GBiICrRCBVBLRAQibqTYqF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_GBiICrRCBVBLRAQibqTYqF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_GBiICrRCBVBLRAQibqTYqF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_GBiICrRCBVBLRAQibqTYqF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_GBiICrRCBVBLRAQibqTYqF
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_GBiICrRCBVBLRAQibqTYqF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_GBiICrRCBVBLRAQibqTYqF(SimStruct *S, int_T tid)
{
  InstanceStruct_GBiICrRCBVBLRAQibqTYqF *moduleInstance =
    (InstanceStruct_GBiICrRCBVBLRAQibqTYqF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_GBiICrRCBVBLRAQibqTYqF(SimStruct *S)
{
  InstanceStruct_GBiICrRCBVBLRAQibqTYqF *moduleInstance =
    (InstanceStruct_GBiICrRCBVBLRAQibqTYqF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_GBiICrRCBVBLRAQibqTYqF(SimStruct *S, int_T tid)
{
  InstanceStruct_GBiICrRCBVBLRAQibqTYqF *moduleInstance =
    (InstanceStruct_GBiICrRCBVBLRAQibqTYqF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_GBiICrRCBVBLRAQibqTYqF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_GBiICrRCBVBLRAQibqTYqF *moduleInstance =
    (InstanceStruct_GBiICrRCBVBLRAQibqTYqF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_GBiICrRCBVBLRAQibqTYqF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_GBiICrRCBVBLRAQibqTYqF *moduleInstance =
    (InstanceStruct_GBiICrRCBVBLRAQibqTYqF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_GBiICrRCBVBLRAQibqTYqF(SimStruct *S)
{
  InstanceStruct_GBiICrRCBVBLRAQibqTYqF *moduleInstance =
    (InstanceStruct_GBiICrRCBVBLRAQibqTYqF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_GBiICrRCBVBLRAQibqTYqF(SimStruct *S)
{
  InstanceStruct_GBiICrRCBVBLRAQibqTYqF *moduleInstance =
    (InstanceStruct_GBiICrRCBVBLRAQibqTYqF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_GBiICrRCBVBLRAQibqTYqF(SimStruct *S)
{
  InstanceStruct_GBiICrRCBVBLRAQibqTYqF *moduleInstance =
    (InstanceStruct_GBiICrRCBVBLRAQibqTYqF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_GBiICrRCBVBLRAQibqTYqF(SimStruct *S)
{
  InstanceStruct_GBiICrRCBVBLRAQibqTYqF *moduleInstance =
    (InstanceStruct_GBiICrRCBVBLRAQibqTYqF *)calloc(1, sizeof
    (InstanceStruct_GBiICrRCBVBLRAQibqTYqF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_GBiICrRCBVBLRAQibqTYqF);
  ssSetmdlInitializeConditions(S, mdlInitialize_GBiICrRCBVBLRAQibqTYqF);
  ssSetmdlUpdate(S, mdlUpdate_GBiICrRCBVBLRAQibqTYqF);
  ssSetmdlTerminate(S, mdlTerminate_GBiICrRCBVBLRAQibqTYqF);
  ssSetmdlEnable(S, mdlEnable_GBiICrRCBVBLRAQibqTYqF);
  ssSetmdlDisable(S, mdlDisable_GBiICrRCBVBLRAQibqTYqF);
...
static void mdlProcessParameters_GBiICrRCBVBLRAQibqTYqF(SimStruct *S)
{
}

void method_dispatcher_GBiICrRCBVBLRAQibqTYqF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_GBiICrRCBVBLRAQibqTYqF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_GBiICrRCBVBLRAQibqTYqF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_GBiICrRCBVBLRAQibqTYqF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_GBiICrRCBVBLRAQibqTYqF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: GBiICrRCBVBLRAQibqTYqF.\n"
...
mxArray *cgxe_GBiICrRCBVBLRAQibqTYqF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_GBiICrRCBVBLRAQibqTYqF_fallback_info(void)
{
