...
#include "m_MwwDQW7VuMYT9t2I9YB8lD.h"
...
static void cgxe_mdl_start(InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD
...
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_arduinobase_internal_DueDACWrite *obj);
static void mw__internal__call__reset(InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD
...
static void cgxe_mdl_set_sim_state(InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_MwwDQW7VuMYT9t2I9YB8lD(SimStruct *S, int_T tid)
{
  InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *moduleInstance =
    (InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_MwwDQW7VuMYT9t2I9YB8lD(SimStruct *S)
{
  InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *moduleInstance =
    (InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_MwwDQW7VuMYT9t2I9YB8lD(SimStruct *S, int_T tid)
{
  InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *moduleInstance =
    (InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_MwwDQW7VuMYT9t2I9YB8lD(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *moduleInstance =
    (InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *)cgxertGetRuntimeInstance(S);
...
static void setSimState_MwwDQW7VuMYT9t2I9YB8lD(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *moduleInstance =
    (InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_MwwDQW7VuMYT9t2I9YB8lD(SimStruct *S)
{
  InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *moduleInstance =
    (InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_MwwDQW7VuMYT9t2I9YB8lD(SimStruct *S)
{
  InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *moduleInstance =
    (InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_MwwDQW7VuMYT9t2I9YB8lD(SimStruct *S)
{
  InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *moduleInstance =
    (InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_MwwDQW7VuMYT9t2I9YB8lD(SimStruct *S)
{
  InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *moduleInstance =
    (InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD *)calloc(1, sizeof
    (InstanceStruct_MwwDQW7VuMYT9t2I9YB8lD));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_MwwDQW7VuMYT9t2I9YB8lD);
  ssSetmdlInitializeConditions(S, mdlInitialize_MwwDQW7VuMYT9t2I9YB8lD);
  ssSetmdlUpdate(S, mdlUpdate_MwwDQW7VuMYT9t2I9YB8lD);
  ssSetmdlTerminate(S, mdlTerminate_MwwDQW7VuMYT9t2I9YB8lD);
  ssSetmdlEnable(S, mdlEnable_MwwDQW7VuMYT9t2I9YB8lD);
  ssSetmdlDisable(S, mdlDisable_MwwDQW7VuMYT9t2I9YB8lD);
...
static void mdlProcessParameters_MwwDQW7VuMYT9t2I9YB8lD(SimStruct *S)
{
}

void method_dispatcher_MwwDQW7VuMYT9t2I9YB8lD(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_MwwDQW7VuMYT9t2I9YB8lD(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_MwwDQW7VuMYT9t2I9YB8lD(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_MwwDQW7VuMYT9t2I9YB8lD(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_MwwDQW7VuMYT9t2I9YB8lD(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: MwwDQW7VuMYT9t2I9YB8lD.\n"
...
mxArray *cgxe_MwwDQW7VuMYT9t2I9YB8lD_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_MwwDQW7VuMYT9t2I9YB8lD_fallback_info(void)
{
