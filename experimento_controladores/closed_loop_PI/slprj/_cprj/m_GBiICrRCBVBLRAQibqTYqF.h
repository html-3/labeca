#ifndef __GBiICrRCBVBLRAQibqTYqF_h__
#define __GBiICrRCBVBLRAQibqTYqF_h__
...
#ifndef struct_tag_6NrroPjWD0jVXt2xKUUOeE
#define struct_tag_6NrroPjWD0jVXt2xKUUOeE

struct tag_6NrroPjWD0jVXt2xKUUOeE
{
  int32_T isInitialized;
  cell_wrap inputVarSize[1];
};

#endif                                 /* struct_tag_6NrroPjWD0jVXt2xKUUOeE */

#ifndef typedef_codertarget_arduinobase_internal_DueDACWrite
#define typedef_codertarget_arduinobase_internal_DueDACWrite

typedef struct tag_6NrroPjWD0jVXt2xKUUOeE
  codertarget_arduinobase_internal_DueDACWrite;

#endif                                 /* typedef_codertarget_arduinobase_internal_DueDACWrite */
...
typedef struct tag_n5V6NPhGd1s3l2q7z9eOR cell;
...
typedef struct tag_VqK0uXiUXuliBvHmvcLR0F b_cell;
...
#ifndef typedef_InstanceStruct_GBiICrRCBVBLRAQibqTYqF
#define typedef_InstanceStruct_GBiICrRCBVBLRAQibqTYqF

typedef struct {
  SimStruct *S;
  codertarget_arduinobase_internal_DueDACWrite sysobj;
  boolean_T sysobj_not_empty;
  void *emlrtRootTLSGlobal;
  uint16_T *u0;
} InstanceStruct_GBiICrRCBVBLRAQibqTYqF;

#endif                                 /* typedef_InstanceStruct_GBiICrRCBVBLRAQibqTYqF */
...
extern void method_dispatcher_GBiICrRCBVBLRAQibqTYqF(SimStruct *S, int_T method,
  void* data);
