###########################################################################
## Makefile generated for component 'pi_test_2'. 
## 
## Makefile     : pi_test_2.mk
## Generated on : Thu Dec 05 14:08:57 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/pi_test_2.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/pi_test_2.elf
...
DEFINES_STANDARD = -DMODEL=pi_test_2 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/pi_test_2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/pi_test_2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/pi_test_2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/pi_test_2_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/pi_test_2_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/pi_test_2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pi_test_2.o : $(START_DIR)/pi_test_2_ert_rtw/pi_test_2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


pi_test_2_data.o : $(START_DIR)/pi_test_2_ert_rtw/pi_test_2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/pi_test_2_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/pi_test_2_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/pi_test_2_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
