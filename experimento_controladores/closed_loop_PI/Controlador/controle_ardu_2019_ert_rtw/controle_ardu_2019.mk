###########################################################################
## Makefile generated for component 'controle_ardu_2019'. 
## 
## Makefile     : controle_ardu_2019.mk
## Generated on : Thu Dec 05 14:07:21 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/controle_ardu_2019.elf
...
PRODUCT_NAME              = controle_ardu_2019
MAKEFILE                  = controle_ardu_2019.mk
MATLAB_ROOT               = C:/PROGRA~1/POLYSP~1/R2021a
MATLAB_BIN                = C:/PROGRA~1/POLYSP~1/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = D:/1_UFRJ/2024.2/labeca/labeca/experimento_controladores/closed_loop_PI/Controlador
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/controle_ardu_2019.elf
...
DEFINES_STANDARD = -DMODEL=controle_ardu_2019 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/controle_ardu_2019_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/controle_ardu_2019_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/controle_ardu_2019_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/controle_ardu_2019_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/controle_ardu_2019_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
controle_ardu_2019.o : $(START_DIR)/controle_ardu_2019_ert_rtw/controle_ardu_2019.c
	$(CC) $(CFLAGS) -o "$@" "$<"


controle_ardu_2019_data.o : $(START_DIR)/controle_ardu_2019_ert_rtw/controle_ardu_2019_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/controle_ardu_2019_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/controle_ardu_2019_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/controle_ardu_2019_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/controle_ardu_2019_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
