...
static void cgxe_mdl_start(InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC
...
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_arduinobase_internal_DueDACWrite *obj);
static void mw__internal__call__reset(InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC
...
static void cgxe_mdl_set_sim_state(InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC
...
static boolean_T k_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_Q3NQfhmrWJEmXkmVukg3ZC(SimStruct *S, int_T tid)
{
  InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *moduleInstance =
    (InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_Q3NQfhmrWJEmXkmVukg3ZC(SimStruct *S)
{
  InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *moduleInstance =
    (InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_Q3NQfhmrWJEmXkmVukg3ZC(SimStruct *S, int_T tid)
{
  InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *moduleInstance =
    (InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_Q3NQfhmrWJEmXkmVukg3ZC(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *moduleInstance =
    (InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *)cgxertGetRuntimeInstance(S);
...
static void setSimState_Q3NQfhmrWJEmXkmVukg3ZC(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *moduleInstance =
    (InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_Q3NQfhmrWJEmXkmVukg3ZC(SimStruct *S)
{
  InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *moduleInstance =
    (InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_Q3NQfhmrWJEmXkmVukg3ZC(SimStruct *S)
{
  InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *moduleInstance =
    (InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_Q3NQfhmrWJEmXkmVukg3ZC(SimStruct *S)
{
  InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *moduleInstance =
    (InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_Q3NQfhmrWJEmXkmVukg3ZC(SimStruct *S)
{
  InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *moduleInstance =
    (InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC *)calloc(1, sizeof
    (InstanceStruct_Q3NQfhmrWJEmXkmVukg3ZC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_Q3NQfhmrWJEmXkmVukg3ZC);
  ssSetmdlInitializeConditions(S, mdlInitialize_Q3NQfhmrWJEmXkmVukg3ZC);
  ssSetmdlUpdate(S, mdlUpdate_Q3NQfhmrWJEmXkmVukg3ZC);
  ssSetmdlTerminate(S, mdlTerminate_Q3NQfhmrWJEmXkmVukg3ZC);
  ssSetmdlEnable(S, mdlEnable_Q3NQfhmrWJEmXkmVukg3ZC);
  ssSetmdlDisable(S, mdlDisable_Q3NQfhmrWJEmXkmVukg3ZC);
...
static void mdlProcessParameters_Q3NQfhmrWJEmXkmVukg3ZC(SimStruct *S)
{
}

void method_dispatcher_Q3NQfhmrWJEmXkmVukg3ZC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_Q3NQfhmrWJEmXkmVukg3ZC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_Q3NQfhmrWJEmXkmVukg3ZC(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_Q3NQfhmrWJEmXkmVukg3ZC(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_Q3NQfhmrWJEmXkmVukg3ZC(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: Q3NQfhmrWJEmXkmVukg3ZC.\n"
...
mxArray *cgxe_Q3NQfhmrWJEmXkmVukg3ZC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_Q3NQfhmrWJEmXkmVukg3ZC_fallback_info(void)
{
